...
function redirigir() {
  ...
  window.location.href = url;
    ...
    function abreVentana(cadena, nombre)
    {
      ...
      miPopup = window.open("consultas/formulariosec.php?val1=" + cadena + "&nombre=" + encodeURIComponent(nombre), "PopUp",'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
