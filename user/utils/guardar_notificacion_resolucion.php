...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nrodetramite'])) {
    ...
    $sql = "UPDATE mlistareportes SET mstatusat = '$accion', mobservacionhis = '$observaciones', mresolucioncasos = '$fecha', mfechasolucion = '$fechaSol' WHERE midformulariogeneral = '$nrodetramite'";
    $sql2 = "INSERT INTO mseguimiento (midformulariogeneral, midestadocaso, musuarioregistro, mfecharegistro, mobservacion) 
        VALUES ('$nrodetramite', '$accion', '$user', '$fecha', '$observaciones')"; 
