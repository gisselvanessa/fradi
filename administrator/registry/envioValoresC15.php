...
$consuls2="update mformulariosgenerales set mcamposad2_es='$cadena_text2_en' where midformulariogeneral='$cadenaPrin' and midcuestionario='$cadena_idCuestionario'";
